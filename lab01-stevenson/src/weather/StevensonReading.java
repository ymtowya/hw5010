...
/**
 * 
 * This class implements the interface {@code WeatherReading}
 * and is based on Stevenson Screen's data collection.
 */
public final class StevensonReading implements WeatherReading {
	...
	/**
	 * Constructs a StevensonReading in terms of its air temperature, its Dew Points, its wind speed and
	 * its total rain as collected by the device.
	 * 
	 ...
	 */
	public StevensonReading(double airTemperature, double dewTemperature, double windSpeed, int totalRain) {
	...
	private double calcRH() {
		return 100 * this.calcVaporPressure(this.dewTemperatureDouble) / this.calcVaporPressure(this.airTemperatureDouble);
	}
